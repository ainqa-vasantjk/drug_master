...
class Despensedefault extends React.Component {
                  ...
                  >
                    ...
                    >
                      ...
                      <Grid
                        ...
                        item={true}
                        lg={"12"}
                        style={qdmstyles.EwXu}
                      >
                        <Paper
                          key={"0"}
                          id={"Sx8CG"}
                          elevation={"{3}"}
                          style={qdmstyles.SxCG}
                        >
                          <Grid
                            key={"0"}
                            id={"h6VuZ"}
                      ...
                      >
                          ...
                          >
                            ...
                            >
                              <TextField
                                ...
                                margin={"none"}
                                aliasName={
                                  "defaultDispenseDuration&UomTextfield"
                                }
                                style={qdmstyles.jDBA}
                              ></TextField>
                            </Grid>
                            <Grid
                              key={"1"}
                            ...
                            >
                              <Autocomplete
                                id={"QfgyC"}
                                style={qdmstyles?.QfgyC}
                                value={
                                  this.state?.despensedefault_qfgyc ?? null
                                }
                                onLoad={() =>
                                  this.setState({
                                    despensedefault_qfgyc:
                                      this.state?.despensedefault_qfgyc ?? null,
                                  })
                                }
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <Autocomplete
                                id={"lTAn2"}
                                style={qdmstyles?.lTAn}
                                value={
                                  this.state?.despensedefault_ltan2 ?? null
                                }
                                onLoad={() =>
                                  this.setState({
                                    despensedefault_ltan2:
                                      this.state?.despensedefault_ltan2 ?? null,
                                  })
                                }
                                getOptionLabel={(option) => option?.["label"]}
                        ...
                        >
                          ...
                          >
                            <Autocomplete
                              id={"Fgzvj"}
                              style={qdmstyles?.Fgzvj}
                              value={this.state?.despensedefault_fgzvj ?? null}
                              onLoad={() =>
                                this.setState({
                                  despensedefault_fgzvj:
                                    this.state?.despensedefault_fgzvj ?? null,
                                })
                              }
                              getOptionLabel={(option) => option?.["label"]}
                              options={[] ?? []}
...
export default connect(
  mapStateToProps,
  actions
)(withRouter(translate()(Despensedefault)));
